...
transpositioncipher tc=new transpositioncipher(key);


        // Printing the ciphere text
        System.out.println("Here The ciphertext is read off along the columns:");
        System.out.println("Cipher Text or expected output : "
                + tc.doEncryption(pt));
    }
}
